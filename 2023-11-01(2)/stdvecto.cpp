...
int main() 
{
    ...
    vector<int>::iterator itor = v.begin();
        for (; itor != v.end(); itor++)  cout << *itor << endl;        //output : 1 2 3 4

    vector<int>::reverse_iterator itor2 = v.rbegin();
        for (; itor2 != v.rend(); itor2++)  cout << *itor2 << endl;        //output : 4 3 2 1
    ...
    cout << v11.capacity() << endl; //output : 10 

    v11.reserve(6);
    cout << v11.capacity() << endl; //output : 6
    cout << v11.max_size() << endl; //output :
